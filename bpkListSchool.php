...
<html>
  ...
  <div class="row">
    <div class="fullcolumn">
      <div class="container">
        <h2>Senarai BPK: Sekolah</h2>

        <!--To count book-->
        <?php 
          $sql = "SELECT * FROM bpk WHERE bpk_category = 'SK'";

          $result = mysqli_query($myConnection, $sql) or die(mysqli_error($myConnection));

          $skcount = mysqli_num_rows($result);

        ?>

        <h3>Jumlah buku: <?php echo $skcount; ?></h3>
          ...
          <table style="border:0 !important;"> 
            <tr style="border:0 !important;">
              ...
              <td width="25%" style="border:0 !important;">
                <form method="post" action="bpkListSchool.php?search=search">
                  <input type="text" name="search" placeholder="Cari No. KP/Nama/No. Fail Jabatan/Nama Sekolah" onblur='this.form.submit()' maxlength="13" autocomplete="off" align="right" size="50">
              ...
              <?php 
                        ...
                        if (mysqli_num_rows($result)==0){
                              ...
                              <tr>
                                ...
                                <td><center><?php echo $row['bpk_school']; ?></center></td>
                                ...
                                <td>
                                  <center>
                                    ...
                                    <br><hr>
                                    <a href="bpkDeleteSK.php?del=<?php echo $row['bpk_staffIC']; ?>" name='edit'>Padam Rekod</i></a>
                                  </center>
                                </td>
                              </tr>
                              <?php
