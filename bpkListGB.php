...
<html>
  ...
  <div class="row">
    <div class="fullcolumn">
      <div class="container">
        <h2>Senarai BPK: Guru-Guru Besar</h2>

        <!--To count book-->
        <?php 
          $sql = "SELECT * FROM bpk WHERE bpk_category = 'GB'";

          $result = mysqli_query($myConnection, $sql) or die(mysqli_error($myConnection));

          $gbcount = mysqli_num_rows($result);

        ?>

        <h3>Jumlah buku: <?php echo $gbcount; ?></h3>
          ...
          <table style="border:0 !important;"> 
            <tr style="border:0 !important;">
              ...
              <td width="25%" style="border:0 !important;">
                <form method="post" action="bpkListGB.php?search=search">
                      ...
                      <tr>
                        ...
                        <td>
                          <center>
                            ...
                            <br><hr>
                            <a href="bpkDeleteGB.php?del=<?php echo $row['bpk_staffIC']; ?>" name='del'>Padam Rekod</i></a>
                          </center>
                        </td>
                      </tr>
